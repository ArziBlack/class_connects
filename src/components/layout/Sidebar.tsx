      ...
      <div className="p-4">
        <div className="flex flex-col h-full">
          <nav className="space-y-1 flex-1">
            ...
            {isTutor && (
              <button className="mt-4 w-full flex items-center space-x-2 px-4 py-2 text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 transition-colors">
                <PlusCircle size={18} />
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-800">
              ...
              <div className="mt-3 space-y-1">
                <NavLink to="/class/1" icon={<GraduationCap size={20} />} text="Mathematics 101" />
                <NavLink to="/class/2" icon={<GraduationCap size={20} />} text="Physics Advanced" />
                <NavLink to="/class/3" icon={<GraduationCap size={20} />} text="Computer Science" />
              </div>
            </div>
          </nav>
